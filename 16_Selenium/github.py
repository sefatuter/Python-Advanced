...
class Github:
    ...
    def signIn(self):
        ...
        self.browser.find_element(By.XPATH, '//*[@id="password"]').send_keys(self.passowrd)
        time.sleep(1)
    ...
    def getFollowers(self):
        self.browser.get("https://github.com/Deepandreinforcement?tab=followers") # f"https://github.com/{self.username}?tab=followers"
        time.sleep(2)
